# coding: utf-8 -*-
# file: Deep_Memory_NN.py
# author: Dr.dajia
# email: drdajie@gmail.com

from Tool_and_Layer import *
import torch
...
class MemNet(nn.Module):
    ...
    def __init__(self, embedding_matrix, opt):
        ...
        self.attention = Attention(opt.embedding_dim, score_function='mlp')
        self.x_linear = nn.Linear(opt.embedding_dim, opt.embedding_dim)
        self.dense = nn.Linear(opt.embedding_dim, opt.num_class)

    def forward(self, inputs):
        text_raw_without_aspect_indices, aspect_indices = inputs['context'], inputs['aspect']
        ...
        memory = squeeze_sequence(memory,memory_len)
